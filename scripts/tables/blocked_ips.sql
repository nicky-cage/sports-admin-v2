create table if not exists blocked_ips ( 
	...
	ip varchar(50) not null default '' comment '设备编号',
...
insert into blocked_ips(ip, user_id, user_name, remark, created, updated, admin_id, admin_name, disabled_all) values 
