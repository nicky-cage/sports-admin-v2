...
type OGDetail struct{}

func NewGameDetail() *OGDetail {
	return new(OGDetail)
}

func (ths *OGDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *OGDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
