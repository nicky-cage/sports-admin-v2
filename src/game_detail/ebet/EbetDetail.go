...
type EbetDetail struct{}

func NewGameDetail() *EbetDetail {
	return new(EbetDetail)
}

func (ths *EbetDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *EbetDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
...
func (ths *EbetDetail) GetDetail(data string, platform string) string {
	var result string
	var err error
