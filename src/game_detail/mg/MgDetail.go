...
func NewGameDetail() *MgDetail {
	return new(MgDetail)
}

func (ths *MgDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
	...
	detail.GameType = "电游" //ext.GameType
...
func (ths *MgDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
...
func (ths *MgDetail) GetDetail(data string, platform string) string {
	var result string
	var err error
