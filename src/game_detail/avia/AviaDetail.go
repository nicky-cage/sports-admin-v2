...
type AviaDetail struct{}

func NewGameDetail() *AviaDetail {
	return new(AviaDetail)
}

func (ths *AviaDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
	...
	detail.VenueCode = "AVIA"
	detail.VenueName = "泛亚电竞"
	detail.GameType = "电竞"
...
func (ths *AviaDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
