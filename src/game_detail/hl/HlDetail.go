...
type HlDetail struct{}

func NewGameDetail() *HlDetail {
	return new(HlDetail)
}

func (ths *HlDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *HlDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
