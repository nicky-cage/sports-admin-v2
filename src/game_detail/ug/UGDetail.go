...
type UGDetail struct{}

func NewGameDetail() *UGDetail {
	return new(UGDetail)
}

func (ths *UGDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *UGDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
