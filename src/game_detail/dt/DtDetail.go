...
type DtDetail struct{}

func NewGameDetail() *DtDetail {
	return new(DtDetail)
}

func (ths *DtDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *DtDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
...
func (ths *DtDetail) GetDetail(data string, platform string) string {
	var result string
	var err error
