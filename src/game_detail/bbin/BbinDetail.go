...
type BbinDetail struct{}

func NewGameDetail() *BbinDetail {
	return new(BbinDetail)
}

func (ths *BbinDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *BbinDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
...
func (ths *BbinDetail) GetDetail(data string, platform string) string {
	var result string
	var err error
