...
type JdbDetail struct{}

func NewGameDetail() *JdbDetail {
	return new(JdbDetail)
}

func (ths *JdbDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *JdbDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
...
func (ths *JdbDetail) GetDetail(data string, platform string) string {
	var result string
	var err error
