...
type VrDetail struct{}

func NewGameDetail() *VrDetail {
	return new(VrDetail)
}

func (ths *VrDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *VrDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
