...
type KyDetail struct{}

func NewGameDetail() *KyDetail {
	return new(KyDetail)
}

func (ths *KyDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *KyDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
