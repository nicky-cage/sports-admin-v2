...
func NewGameDetail() *SGDetail {
	return new(SGDetail)
}

func (ths *SGDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *SGDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
