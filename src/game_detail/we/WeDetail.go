...
type WeDetail struct{}

func NewGameDetail() *WeDetail {
	return new(WeDetail)
}

func (ths *WeDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *WeDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
...
func (ths *WeDetail) GetDetail(data string, platform string) string {
	var result string
	var err error
