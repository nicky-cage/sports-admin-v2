...
type WMDetail struct{}

func NewGameDetail() *WMDetail {
	return new(WMDetail)
}

func (ths *WMDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *WMDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
