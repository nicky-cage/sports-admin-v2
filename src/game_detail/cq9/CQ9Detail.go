...
type CQ9Detail struct{}

func NewGameDetail() *CQ9Detail {
	return new(CQ9Detail)
}

func (ths *CQ9Detail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *CQ9Detail) GetBetInfo(billNo string, platform string) models.WagerRecord {
...
func (ths *CQ9Detail) GetDetail(data string, platform string) string {
	var result string
	var err error
