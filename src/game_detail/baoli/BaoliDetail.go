...
type BaoliDetail struct{}

func NewGameDetail() *BaoliDetail {
	return new(BaoliDetail)
}

func (ths *BaoliDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *BaoliDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
