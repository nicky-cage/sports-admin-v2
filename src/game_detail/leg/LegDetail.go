...
func NewGameDetail() *LegDetail {
	return new(LegDetail)
}

func (ths *LegDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *LegDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
