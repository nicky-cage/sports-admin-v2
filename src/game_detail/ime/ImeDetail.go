...
type ImeDetail struct{}

func NewGameDetail() *ImeDetail {
	return new(ImeDetail)
}

func (ths *ImeDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
	...
	detail.VenueCode = "IME"
	detail.VenueName = "IM电竞"
	detail.GameType = "电竞"
...
func (ths *ImeDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
