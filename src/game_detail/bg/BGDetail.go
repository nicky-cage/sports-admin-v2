...
func NewGameDetail() *BGDetail {
	return new(BGDetail)
}

func (ths *BGDetail) Data(billNo string, platform string) (*models.GameDetail, []*models.GameDetail) {
...
func (ths *BGDetail) GetBetInfo(billNo string, platform string) models.WagerRecord {
...
func (ths *BGDetail) GetDetail(data string, platform string) string {
	var result string
	var err error
